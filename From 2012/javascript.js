$(document).ready(function(){
  var myaudio = new Audio('music/game-over.mp3');
  myaudio.play();
  myaudio.pause();
  myaudio.duration;
  ...
  container = $('.container');
	...
	muted = $('#muted');
	close = $('#close');
	song = new Audio('music/game-over.ogg','music/game-over.mp3');
	duration = song.duration;

  if (song.canPlayType('audio/mpeg;')) {
  	song.type= 'audio/mpeg';
  	song.src= 'music/game-over.mp3';
	} else {
  	song.type= 'audio/ogg';
  	song.src= 'music/game-over.ogg';
	}
